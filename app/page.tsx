  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      ...
      if (!result.detections || result.detections.length === 0) {
        ...
        alert(
          "No animals detected in the image. Try uploading a different image."
        );
      }
        ...
        <div className="container relative z-10 mx-auto max-w-7xl px-4 text-center">
          <div className="mx-auto max-w-3xl space-y-6">
            <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-5xl md:text-6xl">
              AI-Powered{" "}
              <span className="text-blue-600">Wildlife Protection</span>
            </h1>
            <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">
              Real-time detection and risk assessment system to prevent
              wildlife-vehicle collisions. Upload an image to analyze potential
              crossing risks instantly.
            </p>
          </div>
